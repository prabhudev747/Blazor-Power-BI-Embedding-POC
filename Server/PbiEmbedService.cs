...
//// ----------------------------------------------------------------------------
//using BlazorPowerBI.Server.Controllers;
...
//namespace BlazorPowerBI.Services
//{

//    public class PbiEmbedService
//    {
//        private readonly AadService aadService;
//        private readonly IOptions<ReportPowerBIViewModel> powerBI;
//        private readonly string urlPowerBiServiceApiRoot = "https://api.powerbi.com";

//        public PbiEmbedService(AadService aadService, IOptions<ReportPowerBIViewModel> powerBI)
//        {
...
//        public  Em(Guid workspaceId, Guid reportId, [Optional] Guid additionalDatasetId)
//        {
...
//            var embedReports = new List<ReportEmbedReportViewModel>() {
//                new ReportEmbedReportViewModel
//                {
...
//            var embedParams = new ReportEmbedParamsViewModel
//            {
...
//        public ReportEmbedParamsViewModel GetEmbedParams(Guid workspaceId, IList<Guid> reportIds, [Optional] IList<Guid> additionalDatasetIds)
//        {
...
//                // Add report data for embedding
//                embedReports.Add(new ReportEmbedReportViewModel { ReportId = pbiReport.Id, ReportName = pbiReport.Name, EmbedUrl = pbiReport.EmbedUrl });
//            }
...
//            try
//            {
//                string username = powerBI.Value.username.ToString();
//                bool userrole = powerBI.Value.userrole;
//                var rls = new EffectiveIdentity(username: username, new List<string> { datasetIds.FirstOrDefault().ToString() });
